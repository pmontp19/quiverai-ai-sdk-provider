...
```bash
npm install quiverai-ai-provider @ai-sdk/provider@beta @ai-sdk/provider-utils@beta ai@beta
```

```bash
pnpm add quiverai-ai-provider @ai-sdk/provider@beta @ai-sdk/provider-utils@beta ai@beta
```
